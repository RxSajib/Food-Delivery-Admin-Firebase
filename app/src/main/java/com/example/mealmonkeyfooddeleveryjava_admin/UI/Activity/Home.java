package com.example.mealmonkeyfooddeleveryjava_admin.UI.Activity;
...
import com.example.mealmonkeyfooddeleveryjava_admin.Data.Model.NavigationView;
import com.example.mealmonkeyfooddeleveryjava_admin.Network.NetworkViewModel.ViewModel;
import com.example.mealmonkeyfooddeleveryjava_admin.UI.SignIn;
import com.example.mealmonkeyfooddeleveryjava_admin.Views.NavagationAdapter;
...
public class Home extends AppCompatActivity {
    ...
    private void goto_managefoodmenu(){
        Intent intent = new Intent(getApplicationContext(), ManageFoodMenu.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        Animatoo.animateSlideLeft(Home.this);
    }
